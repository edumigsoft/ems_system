...
/// Page for creating or editing a tag.
...
class _TagFormPageState extends State<TagFormPage> {
  ...
  Future<void> _onSubmit() async {
    ...
    if (widget.existingTag != null) {
      ...
      success = await widget.viewModel.updateTag(update);
    } else {
      // Create new tag
      ...
      success = await widget.viewModel.createTag(create);
    }
          ...
          children: [
            ...
            if (isEditing)
              SwitchListTile(
                ...
                subtitle: const Text('Tags inativas não aparecem por padrão'),
                value: _isActive,
