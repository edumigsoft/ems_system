...
echo "  ssh user@vps"
echo ""
log_info "Se for primeira vez, configure o GITHUB_TOKEN:"
echo "  Veja: servers/SETUP_VPS.md"
echo ""
log_info "Deploy da versão ${VERSION}:"
echo "  cd /path/servers"
echo "  ./update.sh ${SERVER} ${VERSION}"
echo ""
log_info "Ou para usar :latest:"
echo "  ./update.sh ${SERVER}"
echo ""
